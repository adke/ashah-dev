...
const featuredProjects = [
  {
    title: "GavelAI",
    description:
      "A small platform for running structured reviews with language models—configure rubrics, kick off batches, and inspect results in a web UI, with a Python API and local model runtime.",
        ...
        >
          <div className="paper-card p-6 md:p-8 folder-tab" data-label="Projects">
            ...
            <p className="text-sm text-muted-foreground max-w-xl">
              Something I built end to end—UI, API, and a bit of model orchestration.
            </p>
          </div>
        </div>
